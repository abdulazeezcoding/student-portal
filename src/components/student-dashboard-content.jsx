...
export default function StudentDashboardContent(){
    return (
        <>
        <div class="md:ml-64 min-h-screen bg-blue-600">

        <div class="flex justify-between sr">
        <h3 class="text-white text-3xl ml-6 mt-4 font-bold">Welcome Ama!</h3>
        ...
        <div class="p-6">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-6">
                ...
                <div class="bg-white rounded-md border border-gray-100 p-6 shadow-md shadow-black/5">
                    <div class="flex justify-between mb-4">
                        <div>
                            <div class="flex items-center mb-1">
                                <div class="text-2xl font-semibold">90</div>
                    ...
                    <div class="rounded-t mb-0 px-0 border-0">
                      <div class="flex flex-wrap items-center px-4 py-2">
                        <div class="relative w-full max-w-full flex-grow flex-1">
                          <h3 class="font-bold text-base text-blue-600 dark:text-gray-50">EXAMINATION</h3>
                        </div>
                      </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
                ...
                <div class="bg-white border border-gray-100 shadow-md shadow-black/5 p-6 rounded-md">
                    <div class="flex justify-between mb-4 items-start">
                        <div class="font-bold text-blue-500">DISCIPLINARY</div>
